...
public:
	...
	__device__ virtual bool rayTrace(Ray ray, float3& hit_point, float3& normal);
	__device__ virtual float3 get_color(float3 frag_point);
};

class Sphere : public Object {
public:
	float radius;
	__device__ bool rayTrace(Ray ray, float3& hit_point, float3& normal) override;
};
...
public:
	...
	__device__ bool rayTrace(Ray ray, float3& hit_point, float3& normal) override;
	__device__ float3 get_color(float3 frag_point) override;
private:
